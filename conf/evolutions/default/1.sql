...
CREATE TABLE WELCOMEALERTHOUR (
  "USERID" VARCHAR(255) PRIMARY KEY,
  "HOUR" INTEGER,
  "MINUTE" INTEGER
);

ALTER TABLE DAYALERT ADD CONSTRAINT FK_DayAlert FOREIGN KEY (ALERTID) REFERENCES ALERT(ID) ON DELETE CASCADE;
...
drop table ALERTDAYFORM;
drop table USERHOME;
drop table WELCOMEALERTHOUR;